        ...
        <div className="mb-4 flex flex-col items-center gap-1.5">
          ...
          <form action={logout} className="w-full">
            <button
              type="submit"
              className="
                group relative flex h-12 w-12 items-center justify-center rounded-[16px]
                text-on-surface-variant transition-[background-color,color,transform] duration-150 ease-out
                hover:bg-[rgb(var(--surface-variant))]/50 hover:text-[rgb(var(--accent-red))]
                motion-safe:active:scale-95 mx-auto
              "
              title="Logout"
              aria-label="Logout"
            >
